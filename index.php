...
<body>
    ...
    <br>
    <br>
    <a href="accueil-admin.php" class="link-primary">Admin</a> <br>
    <a href="admin.php" class="link-primary">Login admin</a> <br>
    <a href="panier.php" class="link-primary">Panier</a> <br><br>

    <button type="button" class="btn btn-primary">
        Voir le panier <span class="badge bg-secondary"> </span>
    </button> <br><br>
